...
public class VerSeguidos {
	public static void execute(String login, String idSesion) {
		try {
			URL url = new URL(Probar.URL_SERVER + "VerSeguidos");
	        ...
	        String SinSeguidos = (String) jsonObject.get("SinSeguidos");
	        String SesionInexistente = (String) jsonObject.get("SesionInexistente");
	        
	        // Comprobamos los parámetros
	        System.out.print("VerSeguidos --> ");
	        if(error != null) {
	        	System.out.println(error);
	        }
	        else if (SinSeguidos != null) {
	        	System.out.println(SinSeguidos);
	        }
