...
public class BorrarCancion {
	public static void execute(String login, String idSesion,
		...
		try {
	        ...
	        String CancionNoExiste = (String) jsonObject.get("CancionNoExiste");
	        String SesionInexistente = (String) jsonObject.get("SesionInexistente");
	        
	        // Comprobamos los parámetros
	        System.out.print("BorrarCancion --> ");
	        if(error != null) {
	        	System.out.println(error);
	        }
	        else if (CancionNoExiste != null) {
	        	System.out.println(CancionNoExiste);
	        }
