...
@WebServlet("/AnyadirCancionUsuario")
public class AnyadirCancionUsuario extends HttpServlet {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		if(!errors.isEmpty()){ // Los parámetros eran incorrectos
			...
			try {
				new ImplementacionFachada().anyadirCancionUsuario(new cancionVO(tituloCancion, nombreArtista, nombreAlbum, genero, uploader));
			}
			catch (CancionYaExiste l) {
				request.setAttribute("ErrorSubirCancion", l.toString());
