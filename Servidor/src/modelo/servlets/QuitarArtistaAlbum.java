...
@WebServlet("/QuitarArtistaAlbum")
public class QuitarArtistaAlbum extends HttpServlet {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		if(!errors.isEmpty()){ // Los parámetros eran incorrectos
			...
			try {
				new ImplementacionFachada().quitarArtistaAlbum(new artistaAlbumVO(nombreArtista, nombreAlbum, ""));
			}
			catch (ArtistaAlbumNoExiste l) {
