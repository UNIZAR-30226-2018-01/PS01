...
@WebServlet("/AnyadirArtistaAlbum")
public class AnyadirArtistaAlbum extends HttpServlet {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response)
		...
		String anyooAlbum = request.getParameter("anyooAlbum");
		...
		if(!errors.isEmpty()){ // Los parámetros eran incorrectos
			...
			try {
				new ImplementacionFachada().anyadirArtistaAlbum(new artistaAlbumVO(nombreArtista, nombreAlbum, anyooAlbum));
			}
			catch (ArtistaAlbumExiste l) {
				request.setAttribute("ArtistaAlbumExiste", l.toString());
